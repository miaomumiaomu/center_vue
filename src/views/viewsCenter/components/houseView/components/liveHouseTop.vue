<template>
  <div class="live-house-top">
		<div class="top">
			<div class="title">房屋居住人数 TOP10</div>
		</div>
		<div class="table">
...
<script>
import{ getHouseMemberTop } from '@/api/viewsCenter/houseView'
export default {
	data() {
		return {
			tableData: [],
	...
	methods: {
		...
		getHouseMemberTop() {
			getHouseMemberTop({ top: 10, ...this.code }).then(res => {
...
.live-house-top{
  ...
  padding: 2.03vh 32px 1.76vh 28px;
	.top{
