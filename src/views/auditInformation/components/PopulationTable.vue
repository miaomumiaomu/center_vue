<template>
  <div class="population-table">
    ...
    >
      ...
      <el-table-column label="人员类别" prop="type" align="center"/>
      <el-table-column label="证件号码" prop="identity" align="center"/>
      <el-table-column label="联系方式" prop="mobile" align="center"/>
      <el-table-column label="关联房屋" prop="house" align="center"/>
